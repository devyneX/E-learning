...
def content(course_id, content_id):
    if request.method == 'GET':
        ...
        return render_template('content.html', user=current_user, creator=creator_teacher, course=course, study_material=content, comments=comments)
...
def assessment(course_id, assessment_id):
    if request.method == 'GET':
        ...
        return render_template('assessment.html', user=current_user, creator=creator_teacher, course=course, assessment=assessment, questions=questions)
